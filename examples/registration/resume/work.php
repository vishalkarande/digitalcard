...
if($ret=mysqli_query($con,"INSERT INTO `resume_work_exp`(`email`, `company_name`, `duration_year`, `designation`, `role`, `duration_month`, `company_location`) VALUES ('$email','$company_name','$durY','$designation','$role','$durM','$location') ")){
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form method="POST">
                        <div class="form-row">
                            <div class="name" >Latest Company Name</div>
                            <div class="value">
						 ...
						 <div class="form-row">
                            <div class="name" >Location(City, State)</div>
                            <div class="value">
						 ...
						 <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="designation">
                            </div>
                        </div>
						...
						<div class="form-row">
                            <div class="name" >Duration of work(Year)</div>
                            <div class="value">
						...
						<div class="form-row">
                            <div class="name" >Duration of work(Month)</div>
                            <div class="value">
                        ...
                        <div class="form-row">
                            <div class="name">Role in Company</div>
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="role" placeholder="write in less than 250 words"></textarea>
                                </div>
                            </div>
                        </div>
						...
						<div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="exp">
                            </div>
