...
if($ret=mysqli_query($con,"UPDATE `resume_detail` SET `personal_profile`='$personal' WHERE email='$email'  ")){
						 ...
						 <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message" placeholder="write abou you in less than 250 words"></textarea>
                                </div>
                            </div>
                        </div>
