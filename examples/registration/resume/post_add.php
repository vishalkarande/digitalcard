            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form method="POST">
						...
						<button type="submit" name="add"  class="btn btn--radius-2 btn--blue-2" style="margin:10%" >Add Post Graduation</button>
