...
if($ret=mysqli_query($con,"INSERT INTO `resume_skill`(`email`, `skill`) VALUES ('$email','$skill') ")){
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Write Your Skills</h2>
                </div>
                <div class="card-body">
                    <form method="POST">
						 ...
						 <div class="form-row">
                            <div class="name"> Your Skills(Eg: c,C++)</div>
                            <div class="value">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="message" placeholder="write your Skills"></textarea>
                                </div>
                            </div>
                        </div>
